      ...
      <div style={gridStyle}>
        ...
        <label style={labelStyle}>
          ...
          <input
            ...
            min="1"
            max="10"
            value={draftFilters.minUniqueEvents ?? ""}
            onChange={(e) => updateField("minUniqueEvents", e.target.value === "" ? "" : Number(e.target.value))}
            style={inputStyle}
        ...
        <label style={labelStyle}>
          ...
          <input
            ...
            min="1"
            max="10"
            value={draftFilters.maxLegsPerGame ?? ""}
            onChange={(e) => updateField("maxLegsPerGame", e.target.value === "" ? "" : Number(e.target.value))}
            style={inputStyle}
            placeholder="No max"
          />
        </label>

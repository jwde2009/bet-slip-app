...
const MARKET_ORDER = {
  ...
  player_rbis: 30,
  player_runs: 31,
  pitcher_strikeouts: 32,
  pitcher_outs_recorded: 33,
  pitcher_earned_runs_allowed: 34,
};
                  ...
                  <input
                    ...
                    onChange={(event) => {
                      ...
                      onUpdateRow(row.id, {
                        ...
                        oddsDecimal: americanToDecimalForParsedRow(next.value),
                        oddsEditedInReview: true,
                        manuallyEdited: true,
                      });
                    }}
                    style={smallInputStyle}
...
function formatMarketLabel(value) {
  ...
  if (text === "player_doubles") return "Doubles";
  if (text === "player_singles") return "Singles";
  if (text === "player_rbis") return "RBIs";
  if (text === "player_runs") return "Runs";
  if (text === "player_stolen_bases") return "Stolen Bases";
  if (text === "player_singles") return "Singles";
  if (text === "player_doubles") return "Doubles";
  if (text === "player_walks") return "Walks";
  if (text === "player_hits_runs_rbis") return "Hits + Runs + RBIs";
  ...
  if (text === "pitcher_walks_allowed") return "Walks Allowed"; 

...
NFL main-line support for Pinnacle, BetMGM, FanDuel, DraftKings and theScore capture is documented in [NFL-main-lines.md](NFL-main-lines.md). `test:parsers` runs both the MLB and NFL suites.
